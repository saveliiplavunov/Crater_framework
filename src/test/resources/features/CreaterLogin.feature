...
Then user should be able so see Page Title "Crater - Self Hosted Invoicing Platform",textbox with label "Email",textbox with label "Password",link title "Forgot password",primary button "Login",text area "Copyright @ Crater Invoice, Inc. 2023",heading "Simple Invoicing for Individuals Small Businesses",and second heading "Crater helps you track expenses, record payments & generate beautiful invoices & estimates"
